...
export default function Now({ title, text }) {
  return (
    <main className="flex-time mt-20 md:mt-20 lg:mt-10 text-white">
      <section className="max-w-sm md:max-w-2xl lg:max-w-3xl mt-10 md:mt-0 lg:mt-0 mb-20 flex flex-col gap-10 bg-black bg-opacity-40 p-10 max-h-max ">
        {" "}
